...
DATE_PATTERN_02 = re.compile(
    r'(?:[0-9\u1040-\u1049]+|(?:တစ်|နှစ်|သုံး|လေး|ငါး|ခြောက်|ခုနှစ်|ရှစ်|ကိုး|ဆယ်|ရာ|ထောင်|သိန်း|သန်း|ရာခိုင်နှုန်း)+)\s*(?:ခု(?:နှစ်)?)?\s*'
...
PROTECT_PATTERNS = [
    ...
    re.compile(r'@@?[A-Za-z0-9_]+'),  # social media mention
    re.compile(r'\b(?:[A-Za-z]\.?\s*){2,}[A-Za-z]?\b'),  # English abbreviation
    re.compile(r'\b(?:Ph\.D|Dr\.|Mr\.|Mrs\.|Ms\.|Prof\.)\b'),  # titles
    re.compile(r'(?:[က-အ]\s*[./-]\s*){2,}[က-အ]?'),  # Burmese abbrev (တ.က.က)
    re.compile(r'(?<![\u1000-\u1021\u102B-\u103E])([\u1000-\u1021]{2,})(?=[\s.,\-@/!?]|$)'),  # Burmese abbrev (တကက)
    re.compile(
    r'(?:'
    r'[0-9\u1040-\u1049]{1,2}[./\-][0-9\u1040-\u1049]{1,2}[./\-][0-9\u1040-\u1049]{2,4}'
    r'|[0-9\u1040-\u1049]{4}[./\-][0-9\u1040-\u1049]{1,2}[./\-][0-9\u1040-\u1049]{1,2}'
    r'|[0-9\u1040-\u1049]{4}\s*-\s*[0-9\u1040-\u1049]{4}'
    r')'),  # date detection
    re.compile(r'(?:[0-9\u1040-\u1049]{1,2}):(?:[0-9\u1040-\u1049]{2})(?::(?:[0-9\u1040-\u1049]{2}))?'),  # time
    re.compile(r'(?:[0-9\u1040-\u1049]+\.[0-9\u1040-\u1049]+)'),  # decimal
    re.compile(r'[0-9\u1040-\u1049]+(?:[,.][0-9\u1040-\u1049]+)+'),  # long number (e.g. ၁,၀၀၀)
    re.compile(r'[0-9\u1040-\u1049]+/[0-9\u1040-\u1049]+'),  # fraction
    re.compile(r'(?:\+?95|09|၀၉)[\s\-]?(?:[0-9\u1040-\u1049][\s\-]?){6,}'),  # phone number
    re.compile(r"\b\w+'[a-zA-Z]+\b"),  # possessive (English)
    re.compile(r'(?<![\u1000-\u1021\u102B-\u103E])(?:တစ်|နှစ်|သုံး|လေး|ငါး|ခြောက်|ခုနစ်|ရှစ်|ကိုး|ဆယ်|ရာ|ထောင်|သောင်း|သိန်း|သန်း|ရာခိုင်နှုန်း)(?:[\u102B-\u103E]*)(?![\u1000-\u1021\u102B-\u103E])'),
    re.compile(r'(?<![\u1000-\u109F])([\u1000-\u109F]*\u1039[\u1000-\u109F]*)(?![\u1000-\u109F])'), #ထပ်ဆင့်
    re.compile(r'[0-9\u1040-\u1049]{2,}'),  # any number (fallback)
]
